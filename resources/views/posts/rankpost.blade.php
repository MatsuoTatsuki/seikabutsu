    ...
    <div class="container mx-auto p-4 flex">
        ...
        <div class="w-3/4 space-y-6">
            ...
            @foreach ($posts as $post)
                ...
                <!-- ランキング項目 -->
                <div class="bg-white shadow-lg rounded-lg p-4 flex items-start space-x-4" style="width: 300px; height: 320px; margin: 0 auto;">
                    <!-- ランキング表示 -->
                    ...
                    <div class="flex-shrink-0">
                        <img src="{{ $post->user->image ?? 'default_icon_url' }}" alt="{{ $post->user->name }}" class="w-16 h-16 rounded-full object-cover">
                    </div>
                    ...
                    <div class="flex-1">
                        ...
                        <!-- 投稿画像 -->
                        @if ($post->post_image)
                            <img src="{{ $post->post_image }}" alt="画像がありません。" class="w-full h-40 object-cover rounded-lg mb-2">
                        @else
                            <img src="{{ asset('images/default.png') }}" alt="画像がありません。" class="w-full h-40 object-cover rounded-lg mb-2">
                        @endif
